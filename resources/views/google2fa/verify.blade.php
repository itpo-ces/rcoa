        ...
        <div class="tfa-section">
            <div class="tfa-container">
                <div class="tfa-header">
                    ...
                    <p class="text-scan">For added security, please provide your Time-Based One-Time Password from Google Authenticator. <strong>You will be unable to login otherwise.</strong></p>
                </div>
                ...
                <div class="text-center">
                    <form action="{{ route('google2fa.check') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="token">Enter the 6-digit token</label>
